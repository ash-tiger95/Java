...
public class SelectBoxRepoImpl implements SelectBoxRepo{
	...
	public List<SiDoCodeDto> selectSido() {
		return sqlSession.selectList("com.project.projectboot.repo.SelectBoxRepo.selectSido");
	}

	@Override
	public List<SiDoCodeDto> selectGugun(String sido) {
		return sqlSession.selectList("com.project.projectboot.repo.SelectBoxRepo.selectGugun",sido);
	}

	@Override
	public List<HouseInfoDto> selectDong(String gugun) {
		return sqlSession.selectList("com.project.projectboot.repo.SelectBoxRepo.selectDong",gugun);
	}

	@Override
	public List<HouseDealDto> selectApt(String dong) {
		return sqlSession.selectList("com.project.projectboot.repo.SelectBoxRepo.selectApt",dong);
	}

	@Override
	public List<HouseInfoDto> selectHouseInfo(String dong) {
		return sqlSession.selectList("com.project.projectboot.repo.SelectBoxRepo.selectHouseInfo",dong);
	}
	...
	public List<HouseDealDto> selectAptbyGudong(String gugun, String dong, int pageNo, int spp) {
		...
		map.put("gugun", gugun);
		map.put("dong", dong);
		return sqlSession.selectList("com.project.projectboot.repo.SelectBoxRepo.selectAptbyGudong",map,row);
	}
	...
	public int dealCount(String gugun, String dong) {
		...
		map.put("gugun", gugun);
		map.put("dong", dong);
		return sqlSession.selectOne("com.project.projectboot.repo.SelectBoxRepo.dealCount", map);
	}

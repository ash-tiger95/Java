          ...
          db.User.create({
            ...
            var mailOpt = {
              ...
              html:
                ...
                "<form method='post' action='https://serverName/api/auth/approval'>" +
...
app.post("/approval", async (req, res) => {
  await db.User.update(
    ...
    .then(() =>
      res.send(
        '<script type="text/javascript">alert("인증이 완료되었습니다. 로그인 후 이용하세요."); window.location="https://serverName/"; </script>'
      )
    )
    .catch((err) =>
      res.send(

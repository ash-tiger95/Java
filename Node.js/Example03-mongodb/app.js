...
router.route('/process/login').post(function(req, res) {
	...
	if (database) {
		authUser(database, paramId, paramPassword, function(err, docs) {
			...
			if (docs) {
				console.log("로그인 성공");
				console.log("사용자 이름: " + docs[0].name);
				console.log("사용자 ID: " + docs[0].id);
				console.log("사용자 password: " + docs[0].password);
	...
	if (database) {
		addUser(database, paramId, paramPassword, paramName, function(err, addedUser) {
			...
			if (addedUser) {
				...
				console.log("사용자 이름: " + addedUser.name);
				console.log("사용자 ID: " + addedUser.id);
				console.log("사용자 password: " + addedUser.password);
